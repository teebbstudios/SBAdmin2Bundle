    ...
    private function addOptionsSection(ArrayNodeDefinition $rootNode){
        $rootNode
            ->children()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('search')->info('Enable/Disable the top bar search form.')
                            ->children()
                                ->scalarNode('admin')->info('Search which admin content.')->end()
                                ->scalarNode('placeholder')->defaultValue('Search Something')->info('Search input placeholder.')->end()
                                ->arrayNode('property')->info('Which admin entity fields for search.')
                                    ->scalarPrototype()
                                        ->defaultValue([])
                                    ->end()
                                ->end()
                                ->arrayNode('roles')->info('Search admin entity field.')
                                    ->scalarPrototype()
                                        ->defaultValue([])
                                    ->end()
                                ->end()
